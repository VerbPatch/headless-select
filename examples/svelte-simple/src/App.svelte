...
<main style="padding: 2rem; max-width: 1000px; margin: 0 auto;">
  <h1>Svelte Headless Select Showcase</h1>
  <p>Demonstrating various configurations of the Svelte adapter.</p>
  ...
  <section style="margin-bottom: 3rem;">
    ...
    <div style="margin-bottom: 1.5rem;">
      ...
      >
        ...
        <button
          on:click={() => (multiValue = ['apple', 'carrot'])}
