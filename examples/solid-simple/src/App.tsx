...
export default function App() {
  const [multiValue, setMultiValue] = createSignal<string[]>(['apple', 'banana']);
  const [singleValue, setSingleValue] = createSignal<string>('banana');

  return (
    <div style={{ padding: '2rem', 'max-width': '1000px', margin: '0 auto' }}>
      <h1>SolidJS Headless Select Showcase</h1>
      <p>Demonstrating various configurations of the SolidJS adapter.</p>
